...
export default function SidebarMini() {
  ...
  return (
    <div className={clsx('flex sm:p-2 order-2 sm:order-1 mt-auto sm:flex flex-row justify-between bg-background sm:mt-0 sm:flex-col sm:items-center sm:justify-center text-foreground' , route().current('chats.show') ? 'hidden' : 'flex')}>
