...
export default function ProfileInformation({
    ...
    return (
        <Transition
            ...
            className={clsx(
                "w-full flex-col gap-4 text-foreground lg:flex",
        ...
        >
                ...
                {user.chat_type === CHAT_TYPE.GROUP_CHATS && (
                    <div>
                        ...
                        >
                            <FaInfoCircle
                                className={clsx(
                                    !user.message_color && "!text-primary",
                                )}
            ...
            <div className="px-2">
                <button
                    className="flex w-full items-center justify-between rounded-lg px-3 py-2 text-xs hover:bg-secondary focus:bg-secondary"
                ...
                {toggleCustomizeChat && (
                    <button
                        className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-xs hover:bg-secondary focus:bg-secondary"
                ...
                <button
                    className="flex w-full items-center justify-between rounded-lg px-3 text-xs py-2 hover:bg-secondary focus:bg-secondary"
